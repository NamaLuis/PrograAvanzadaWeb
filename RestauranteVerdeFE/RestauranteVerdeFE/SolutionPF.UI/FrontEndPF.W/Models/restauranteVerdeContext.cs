...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-LL0078J\\SQLEXPRESS;Database=restauranteVerde;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Cliente>(entity =>
            {
                entity.HasKey(e => e.Cedula)
                    .HasName("PK__cliente__415B7BE4539A45CF");
            ...
            {
                entity.HasKey(e => e.Cedula)
                    .HasName("PK__empleado__415B7BE4FDE85204");
                ...
                entity.HasOne(d => d.IdPuestoNavigation)
                    ...
                    .HasConstraintName("FK__empleado__id_pue__3A81B327");
            });
