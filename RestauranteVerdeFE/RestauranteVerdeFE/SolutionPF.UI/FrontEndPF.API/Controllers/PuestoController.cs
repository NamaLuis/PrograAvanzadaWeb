...
namespace FrontEndPF.API.Controllers
{
    public class PuestoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre")] Models.Puesto puesto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre")] Models.Puesto puesto)
        {
            if (id != puesto.Id)
            {
                return NotFound();
